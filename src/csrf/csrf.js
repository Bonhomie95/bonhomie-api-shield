...
/**
 * Middleware to ensure CSRF cookie exists and expose req.csrfToken
 *
 * Requires cookie support (e.g. cookie-parser in Express).
 *
 * @param {{
 *  cookieName?: string;
...
/**
 * Middleware to validate CSRF token using
 * double-submit cookie pattern.
 *
 * - Cookie: csrf_token
 * - Header: x-csrf-token OR body.csrfToken OR query.csrfToken
 *
 * @param {{
 *  cookieName?: string;
 *  headerName?: string;
